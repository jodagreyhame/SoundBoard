...
**Report via GitHub:** open a private report from the repository's **Security** tab, or use
GitHub's own abuse reporting at https://github.com/contact/report-abuse
...
2. **Investigation** - We gather facts and context
3. **Decision** - We determine if the Code of Conduct was violated
4. **Action** - We take appropriate action (see below)
5. **Follow-up** - We check in with affected parties
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1, which is available at https://www.contributor-covenant.org/version/2/1/code_of_conduct/.

## Questions?

If you have questions about this Code of Conduct, please reach out:
- **GitHub Issues:** [SoundBoard/issues](https://github.com/jodagreyhame/SoundBoard/issues)
- **GitHub Discussions:** [SoundBoard/discussions](https://github.com/jodagreyhame/SoundBoard/discussions)
